        ...
        <form onSubmit={submitForm}>
          <div id="row">
            <div id="grosze">
              ...
              <input id="gr1" type="number" name="gr1" placeholder="0" min="0" />

              <label htmlFor="gr2">2gr</label>
              <input id="gr2" type="number" name="gr2" placeholder="0" min="0" />

              <label htmlFor="gr5">5gr</label>
              <input id="gr5" type="number" name="gr5" placeholder="0" min="0" />

              <label htmlFor="gr10">10gr</label>
              <input id="gr10" type="number" name="gr10" placeholder="0" min="0" />

              <label htmlFor="gr20">20gr</label>
              <input id="gr20" type="number" name="gr20" placeholder="0" min="0" />

              <label htmlFor="gr50">50gr</label>
              <input id="gr50" type="number" name="gr50" placeholder="0" min="0" />
            </div>
            <div id="zlotowki">
              <h3>Złotówki</h3>
              <label htmlFor="zl1">1zł</label>
              <input id="zl1" type="number" name="zl1" placeholder="0" min="0" />

              <label htmlFor="zl2">2zł</label>
              <input id="zl2" type="number" name="zl2" placeholder="0" min="0" />

              <label htmlFor="zl5">5zł</label>
              <input id="zl5" type="number" name="zl5" placeholder="0" min="0" />
            </div>
            <div id="banknoty">
              <h3>Banknoty</h3>
              <label htmlFor="zl10">10zł</label>
              <input id="zl10" type="number" name="zl10" placeholder="0" min="0" />

              <label htmlFor="zl20">20zł</label>
              <input id="zl20" type="number" name="zl20" placeholder="0" min="0" />

              <label htmlFor="zl50">50zł</label>
              <input id="zl50" type="number" name="zl50" placeholder="0" min="0" />

              <label htmlFor="zl100">100zł</label>
              <input id="zl100" type="number" name="zl100" placeholder="0" min="0" />

              <label htmlFor="zl200">200zł</label>
              <input id="zl200" type="number" name="zl200" placeholder="0" min="0" />

              <label htmlFor="zl500">500zł</label>
              <input id="zl500" type="number" name="zl500" placeholder="0" min="0" />
            </div>
          </div>
